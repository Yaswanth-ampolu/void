...
import { FeatureName, ModelSelectionOptions, OverridesOfModel, ProviderName } from './pinnacleaiSettingsTypes.js';
...
export type PinnacleStaticModelInfo = { // not stateful
	// Pinnacle uses the information below to know how to handle each model.
...
type PinnacleStaticProviderInfo = { // doesn't change (not stateful)
	...
	modelOptions: { [key: string]: PinnacleStaticModelInfo };
	modelOptionsFallback: (modelName: string, fallbackKnownValues?: Partial<PinnacleStaticModelInfo>) => (PinnacleStaticModelInfo & { modelName: string, recognizedModelName: string }) | null;
}
...
const defaultModelOptions = {
	...
	supportsFIM: false,
	reasoningCapabilities: false,
} as const satisfies PinnacleStaticModelInfo
...
} as const satisfies { [s: string]: Partial<PinnacleStaticModelInfo> }




// keep modelName, but use the fallback's defaults
const extensiveModelOptionsFallback: PinnacleStaticProviderInfo['modelOptionsFallback'] = (modelName, fallbackKnownValues) => {

	const lower = modelName.toLowerCase()

	const toFallback = <T extends { [s: string]: Omit<PinnacleStaticModelInfo, 'cost' | 'downloadable'> },>(obj: T, recognizedModelName: string & keyof T)
		: PinnacleStaticModelInfo & { modelName: string, recognizedModelName: string } => {
...
} as const satisfies { [s: string]: PinnacleStaticModelInfo }

const anthropicSettings: PinnacleStaticProviderInfo = {
...
const openAISettings: PinnacleStaticProviderInfo = {
...
const xAISettings: PinnacleStaticProviderInfo = {
...
const geminiSettings: PinnacleStaticProviderInfo = {
...
const deepseekSettings: PinnacleStaticProviderInfo = {
...
const mistralSettings: PinnacleStaticProviderInfo = {
...
const groqSettings: PinnacleStaticProviderInfo = {
...
} as const satisfies Record<string, PinnacleStaticModelInfo>
const googleVertexSettings: PinnacleStaticProviderInfo = {
...
const microsoftAzureSettings: PinnacleStaticProviderInfo = {
...
const awsBedrockSettings: PinnacleStaticProviderInfo = {
...
const vLLMSettings: PinnacleStaticProviderInfo = {
...
const lmStudioSettings: PinnacleStaticProviderInfo = {
...
const ollamaSettings: PinnacleStaticProviderInfo = {
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
...
const openaiCompatible: PinnacleStaticProviderInfo = {
...
const liteLLMSettings: PinnacleStaticProviderInfo = { // https://docs.litellm.ai/docs/reasoning_content
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
	modelOptions: {},
	providerReasoningIOSettings: {
		input: { includeInPayload: openAICompatIncludeInPayloadReasoning },
...
const openRouterSettings: PinnacleStaticProviderInfo = {
...
const modelSettingsOfProvider: { [providerName in ProviderName]: PinnacleStaticProviderInfo } = {
