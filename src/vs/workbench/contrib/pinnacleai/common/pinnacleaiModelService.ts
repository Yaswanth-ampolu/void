...
type PinnacleAIModelType = {
	model: ITextModel | null;
	editorModel: IResolvedTextEditorModel | null;
};

export interface IPinnacleAIModelService {
	readonly _serviceBrand: undefined;
	initializeModel(uri: URI): Promise<void>;
	getModel(uri: URI): PinnacleAIModelType;
	getModelFromFsPath(fsPath: string): PinnacleAIModelType;
	getModelSafe(uri: URI): Promise<PinnacleAIModelType>;
	saveModel(uri: URI): Promise<void>;

}

export const IPinnacleAIModelService = createDecorator<IPinnacleAIModelService>('pinnacleaiModelService');

class PinnacleAIModelService extends Disposable implements IPinnacleAIModelService {
	_serviceBrand: undefined;
	static readonly ID = 'pinnacleaiModelService';
	...
	getModelSafe = async (uri: URI): Promise<PinnacleAIModelType> => {
...
registerSingleton(IPinnacleAIModelService, PinnacleAIModelService, InstantiationType.Eager); 