...
// gets converted to --vscode-pinnacleai-greenBG, see pinnacleai.css, asCssVariable
registerColor('pinnacleai.greenBG', configOfBG(acceptBG), '', true);
registerColor('pinnacleai.redBG', configOfBG(rejectBG), '', true);
registerColor('pinnacleai.sweepBG', configOfBG(sweepBG), '', true);
registerColor('pinnacleai.highlightBG', configOfBG(highlightBG), '', true);
registerColor('pinnacleai.sweepIdxBG', configOfBG(sweepIdxBG), '', true); 