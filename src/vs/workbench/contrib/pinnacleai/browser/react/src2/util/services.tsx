...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/pinnacleai/common/pinnacleaiSettingsTypes.js';
import { IDisposable } from '../../../../../../../base/common/lifecycle.js';
import { PinnacleSettingsState } from '../../../../../../../workbench/contrib/pinnacleai/common/pinnacleaiSettingsService.js';
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js';
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/pinnacleai/common/refreshModelService.js';
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/pinnacleai/common/refreshModelService.js';
import { IPinnacleSettingsService } from '../../../../../../../workbench/contrib/pinnacleai/common/pinnacleaiSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/pinnacleai/browser/extensionTransferService.js';
...
import { IMetricsService } from '../../../../../../../workbench/contrib/pinnacleai/common/metricsService.js';
...
let settingsState: PinnacleSettingsState;
const settingsStateListeners: Set<(s: PinnacleSettingsState) => void> = new Set();
...
export const _registerServices = (accessor: ServicesAccessor) => {
  ...
  const stateServices = {
    ...
    settingsStateService: accessor.get(IPinnacleSettingsService),
    refreshModelService: accessor.get(IRefreshModelService),
    themeService: accessor.get(IThemeService),
    editCodeService: accessor.get(IEditCodeService),
    pinnacleaiCommandBarService: accessor.get(IPinnacleAICommandBarService),
    modelService: accessor.get(IModelService),
    mcpService: accessor.get(IMCPService)
  };

  const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, pinnacleaiCommandBarService, modelService, mcpService } = stateServices;
  ...
  disposables.push(
    pinnacleaiCommandBarService.onDidChangeState(({ uri }) => {
      commandBarURIStateListeners.forEach((l) => l(uri));
    })
  );

  disposables.push(
    pinnacleaiCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
  const reactAccessor = {
    ...
    IPinnacleSettingsService: accessor.get(IPinnacleSettingsService),
    ...
    IPinnacleAIModelService: accessor.get(IPinnacleAIModelService),
    IWorkspaceContextService: accessor.get(IWorkspaceContextService),

    IPinnacleAICommandBarService: accessor.get(IPinnacleAICommandBarService),
...
export const useAccessor = () => {
  if (!reactAccessor_) {
    throw new Error(`⚠️ PinnacleAI useAccessor was called before _registerServices!`);
  }
