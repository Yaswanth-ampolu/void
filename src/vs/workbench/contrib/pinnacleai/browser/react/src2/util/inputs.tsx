...
export const WidgetComponent = <CtorParams extends any[], Instance>({ ctor, propsFn, dispose, onCreateInstance, children, className
  ...
  return <div ref={containerRef} className={className === undefined ? `pinnacleai-w-full` : className}>{children}</div>;
};
...
export const PinnacleInputBox2 = forwardRef<HTMLTextAreaElement, InputBox2Props>(function X({ initValue, placeholder, multiline, enableAtToMention, fnsRef, className, onKeyDown, onFocus, onBlur, onChangeText }, ref) {
  ...
  return <>
      ...
      className={`pinnacleai-w-full pinnacleai-resize-none pinnacleai-max-h-[500px] pinnacleai-overflow-y-auto pinnacleai-text-pinnacleai-fg-1 placeholder:pinnacleai-text-pinnacleai-fg-3 ${className}`}
      style={{
    ...
    <div
      ...
      className="pinnacleai-z-[100] pinnacleai-border-pinnacleai-border-3 pinnacleai-bg-pinnacleai-bg-2-alt pinnacleai-border pinnacleai-rounded pinnacleai-shadow-lg pinnacleai-flex pinnacleai-flex-col pinnacleai-overflow-hidden"
      style={{
        position: strategy,
        top: y ?? 0,
        left: x ?? 0,
      ...
      onWheel={(e) => e.stopPropagation()}>
				...
				{/* Breadcrumbs Header */}
				{isBreadcrumbsShowing && <div className="pinnacleai-px-2 pinnacleai-py-1 pinnacleai-text-pinnacleai-fg-1 pinnacleai-bg-pinnacleai-bg-2-alt pinnacleai-border-b pinnacleai-border-pinnacleai-border-3 pinnacleai-sticky pinnacleai-top-0 pinnacleai-bg-pinnacleai-bg-1 pinnacleai-z-10 pinnacleai-select-none pinnacleai-pointer-events-none">
					{optionText ?
        ...
        <div className="pinnacleai-opacity-50">Enter text to filter...</div>
        }
				</div>}


				{/* Options list */}
				<div className="pinnacleai-max-h-[400px] pinnacleai-w-full pinnacleai-max-w-full pinnacleai-overflow-y-auto pinnacleai-overflow-x-auto">
					<div className="pinnacleai-w-max pinnacleai-min-w-full pinnacleai-flex pinnacleai-flex-col pinnacleai-gap-0 pinnacleai-text-nowrap pinnacleai-flex-nowrap">
						{options.length === 0 ?
          <div className="pinnacleai-text-pinnacleai-fg-3 pinnacleai-px-3 pinnacleai-py-0.5">No results found</div> :
          options.map((o, oIdx) => {
            ...
            return (
              ...
              <div
                ...
                key={o.fullName}
                className={` pinnacleai-flex pinnacleai-items-center pinnacleai-gap-2 pinnacleai-px-3 pinnacleai-py-1 pinnacleai-cursor-pointer ${


                oIdx === optionIdx ? "pinnacleai-bg-blue-500 pinnacleai-text-white/80" : "pinnacleai-bg-pinnacleai-bg-2-alt pinnacleai-text-pinnacleai-fg-1"} `}
                ...
                onMouseMove={() => {setOptionIdx(oIdx);}}>
										...
										{o.fullName && o.fullName !== o.abbreviatedName && <span className="pinnacleai-opacity-60 pinnacleai-text-sm">{o.fullName}</span>}
...
export const PinnacleSimpleInputBox = ({ value, onChangeValue, placeholder, className, disabled, passwordBlur, compact, ...inputProps
  ...
  return (
    <input
      ...
      placeholder={placeholder}
      disabled={disabled}
      className={`pinnacleai-w-full pinnacleai-resize-none pinnacleai-bg-pinnacleai-bg-1 pinnacleai-text-pinnacleai-fg-1 placeholder:pinnacleai-text-pinnacleai-fg-3 pinnacleai-border pinnacleai-border-pinnacleai-border-2 focus:pinnacleai-border-pinnacleai-border-1 ${
      compact ? "pinnacleai-py-1 pinnacleai-px-2" : "pinnacleai-py-2 pinnacleai-px-4 "} pinnacleai-rounded ${

      disabled ? "pinnacleai-opacity-50 pinnacleai-cursor-not-allowed" : ""} ${
      className}`}
      style={{
...
export const PinnacleInputBox = ({ onChangeText, onCreateInstance, inputBoxRef, placeholder, isPasswordField, multiline
  ...
  return <WidgetComponent
    className=" pinnacleai-bg-pinnacleai-bg-1 pinnacleai-force-child-placeholder-pinnacleai-fg-1 "
...
export const PinnacleSlider = ({
  ...
  return (
    <div className={`pinnacleai-inline-flex pinnacleai-items-center pinnacleai-flex-shrink-0 ${className}`}>
			{/* Outer container with padding to account for thumb overhang */}
			<div className={`pinnacleai-relative pinnacleai-flex-shrink-0 ${disabled ? "pinnacleai-opacity-25" : ""}`}
      style={{
        width
        ...
        // paddingRight: thumbSizePx / 2
				...
				<div className="pinnacleai-relative pinnacleai-w-full">
					...
					<div
            className="pinnacleai-absolute pinnacleai-w-full pinnacleai-cursor-pointer"
            style={{
              height: '16px',
              top: '50%',
            ...
            onClick={handleTrackClick} />
					...
					{/* Track */}
					<div
            className={`pinnacleai-relative ${size === 'xxs' ? "pinnacleai-h-0.5" :
            size === 'xs' ? "pinnacleai-h-1" :
            size === 'sm' ? "pinnacleai-h-1.5" :
            size === 'sm+' ? "pinnacleai-h-2" : "pinnacleai-h-2.5"} pinnacleai-bg-pinnacleai-bg-2 pinnacleai-rounded-full pinnacleai-cursor-pointer`}

            onClick={handleTrackClick}>
            
						{/* Filled part of track */}
						<div
              className={`pinnacleai-absolute pinnacleai-left-0 ${size === 'xxs' ? "pinnacleai-h-0.5" :
              size === 'xs' ? "pinnacleai-h-1" :
              size === 'sm' ? "pinnacleai-h-1.5" :
              size === 'sm+' ? "pinnacleai-h-2" : "pinnacleai-h-2.5"} pinnacleai-bg-pinnacleai-fg-1 pinnacleai-rounded-full`}
              ...
              style={{ width: `${percentage}%` }} />
					...
					{/* Thumb */}
					<div
            className={`pinnacleai-absolute pinnacleai-top-1/2 pinnacleai-transform -pinnacleai-translate-x-1/2 -pinnacleai-translate-y-1/2 ${
            size === 'xxs' ? "pinnacleai-h-2 pinnacleai-w-2" :
            size === 'xs' ? "pinnacleai-h-2.5 pinnacleai-w-2.5" :
            size === 'sm' ? "pinnacleai-h-3 pinnacleai-w-3" :
            size === 'sm+' ? "pinnacleai-h-3.5 pinnacleai-w-3.5" : "pinnacleai-h-4 pinnacleai-w-4"} pinnacleai-bg-pinnacleai-fg-1 pinnacleai-rounded-full pinnacleai-shadow-md ${

            disabled ? "pinnacleai-cursor-not-allowed" : "pinnacleai-cursor-grab active:pinnacleai-cursor-grabbing"} pinnacleai-border pinnacleai-border-pinnacleai-fg-1`}
...
export const PinnacleSwitch = ({
  ...
  return (
    <label className="pinnacleai-inline-flex pinnacleai-items-center" {...props}>
			<div
        onClick={() => !disabled && onChange(!value)}
        className={` pinnacleai-cursor-pointer pinnacleai-relative pinnacleai-inline-flex pinnacleai-items-center pinnacleai-rounded-full pinnacleai-transition-colors pinnacleai-duration-200 pinnacleai-ease-in-out ${


        value ? "pinnacleai-bg-zinc-900 dark:pinnacleai-bg-white" : "pinnacleai-bg-white dark:pinnacleai-bg-zinc-600"} ${
        disabled ? "pinnacleai-opacity-25" : ""} ${
        size === 'xxs' ? "pinnacleai-h-3 pinnacleai-w-5" : ""} ${
        size === 'xs' ? "pinnacleai-h-4 pinnacleai-w-7" : ""} ${
        size === 'sm' ? "pinnacleai-h-5 pinnacleai-w-9" : ""} ${
        size === 'sm+' ? "pinnacleai-h-5 pinnacleai-w-10" : ""} ${
        size === 'md' ? "pinnacleai-h-6 pinnacleai-w-11" : ""} `}>

        
				<span
          className={` pinnacleai-inline-block pinnacleai-transform pinnacleai-rounded-full pinnacleai-bg-white dark:pinnacleai-bg-zinc-900 pinnacleai-shadow pinnacleai-transition-transform pinnacleai-duration-200 pinnacleai-ease-in-out ${

          size === 'xxs' ? "pinnacleai-h-2 pinnacleai-w-2" : ""} ${
          size === 'xs' ? "pinnacleai-h-2.5 pinnacleai-w-2.5" : ""} ${
          size === 'sm' ? "pinnacleai-h-3 pinnacleai-w-3" : ""} ${
          size === 'sm+' ? "pinnacleai-h-3.5 pinnacleai-w-3.5" : ""} ${
          size === 'md' ? "pinnacleai-h-4 pinnacleai-w-4" : ""} ${
          size === 'xxs' ? value ? "pinnacleai-translate-x-2.5" : "pinnacleai-translate-x-0.5" : ""} ${
          size === 'xs' ? value ? "pinnacleai-translate-x-3.5" : "pinnacleai-translate-x-0.5" : ""} ${
          size === 'sm' ? value ? "pinnacleai-translate-x-5" : "pinnacleai-translate-x-1" : ""} ${
          size === 'sm+' ? value ? "pinnacleai-translate-x-6" : "pinnacleai-translate-x-1" : ""} ${
          size === 'md' ? value ? "pinnacleai-translate-x-6" : "pinnacleai-translate-x-1" : ""} `} />
...
export const PinnacleCheckBox = ({ label, value, onClick, className }: {label: string;value: boolean;onClick: (checked: boolean) => void;className?: string;}) => {
...
export const PinnacleCustomDropdownBox = <T extends NonNullable<any>,>({
  options,
  selectedOption,
  onChangeOption,
  ...
  return (
    <div className={`pinnacleai-inline-block pinnacleai-relative ${className}`}>
			{/* Hidden measurement div */}
			<div
        ref={measureRef}
        className="pinnacleai-opacity-0 pinnacleai-pointer-events-none pinnacleai-absolute -pinnacleai-left-[999999px] -pinnacleai-top-[999999px] pinnacleai-flex pinnacleai-flex-col"
        aria-hidden="true">
          ...
          return (
            <div key={optionName + optionDetail} className="pinnacleai-flex pinnacleai-items-center pinnacleai-whitespace-nowrap">
							<div className="pinnacleai-w-4" />
							<span className="pinnacleai-flex pinnacleai-justify-between pinnacleai-w-full">
        ...
        className="pinnacleai-flex pinnacleai-items-center pinnacleai-h-4 pinnacleai-bg-transparent pinnacleai-whitespace-nowrap hover:pinnacleai-brightness-90 pinnacleai-w-full"
        onClick={() => setIsOpen(!isOpen)}>
        
				<span className={`pinnacleai-truncate ${arrowTouchesText ? "pinnacleai-mr-1" : ""}`}>
					{getOptionDisplayName(selectedOption)}
				</span>
				<svg
          className={`pinnacleai-size-3 pinnacleai-flex-shrink-0 ${arrowTouchesText ? "" : "pinnacleai-ml-auto"}`}
          viewBox="0 0 12 12"
          fill="none">
      ...
      <div
        ref={refs.setFloating}
        className="pinnacleai-z-[100] pinnacleai-bg-pinnacleai-bg-1 pinnacleai-border-pinnacleai-border-3 pinnacleai-border pinnacleai-rounded pinnacleai-shadow-lg"
        style={{
          position: strategy,
          top: y ?? 0,
          left: x ?? 0,
        ...
        onWheel={(e) => e.stopPropagation()}>
        <div className="pinnacleai-overflow-auto pinnacleai-max-h-80">
            ...
            return (
              <div
                key={optionName}
                className={`pinnacleai-flex pinnacleai-items-center pinnacleai-px-2 pinnacleai-py-1 pinnacleai-pr-4 pinnacleai-cursor-pointer pinnacleai-whitespace-nowrap pinnacleai-transition-all pinnacleai-duration-100 ${

                thisOptionIsSelected ? "pinnacleai-bg-blue-500 pinnacleai-text-white/80" : "hover:pinnacleai-bg-blue-500 hover:pinnacleai-text-white/80"} `}
                ...
                onClick={() => {
                  ...
                  setIsOpen(false);
									...
									<div className="pinnacleai-w-4 pinnacleai-flex pinnacleai-justify-center pinnacleai-flex-shrink-0">
										{thisOptionIsSelected &&
                  <svg className="pinnacleai-size-3" viewBox="0 0 12 12" fill="none">
												<path
                      d="M10 3L4.5 8.5L2 6"
                      stroke="currentColor"
                      strokeWidth="1.5"
                      ...
                      strokeLinejoin="round" />
									...
									<span className="pinnacleai-flex pinnacleai-justify-between pinnacleai-items-center pinnacleai-w-full pinnacleai-gap-x-1">
										<span>{optionName}</span>
										<span className="pinnacleai-opacity-60">{optionDetail}</span>
									</span>
								</div>);
...
export const _PinnacleSelectBox = <T,>({ onChangeSelection, onCreateInstance, selectBoxRef, options, className
  ...
  return <WidgetComponent
    className={` select-child-restyle [&_select]:!pinnacleai-text-pinnacleai-fg-3 [&_select]:!pinnacleai-text-xs !pinnacleai-text-pinnacleai-fg-3 ${
...
export const BlockCode = ({ initValue, language, maxHeight, showScrollbars }: BlockCodeProps) => {
  ...
  return <div ref={divRef} className="pinnacleai-relative pinnacleai-z-0 pinnacleai-px-2 pinnacleai-py-1 pinnacleai-bg-pinnacleai-bg-3">
		<WidgetComponent
...
export const PinnacleButtonBgDarken = ({ children, disabled, onClick, className }: {children: React.ReactNode;disabled?: boolean;onClick: () => void;className?: string;}) => {
  return <button disabled={disabled}
  className={`pinnacleai-px-3 pinnacleai-py-1 pinnacleai-bg-black/10 dark:pinnacleai-bg-white/10 pinnacleai-rounded-sm pinnacleai-overflow-hidden pinnacleai-whitespace-nowrap pinnacleai-flex pinnacleai-items-center pinnacleai-justify-center ${className || ''}`}
  onClick={onClick}>
    {children}</button>;
};
...
const SingleDiffEditor = ({ block, lang }: {block: ExtractedSearchReplaceBlock;lang: string | undefined;}) => {
  ...
  return (
    <div className="pinnacleai-w-full pinnacleai-bg-pinnacleai-bg-3 bg-editor-style-override" ref={divRef} />);
 ...
 */
export const PinnacleDiffEditor = ({ uri, searchReplaceBlocks, language }: {uri?: any;searchReplaceBlocks: string;language?: string;}) => {
  const accessor = useAccessor();
  const languageService = accessor.get('ILanguageService');
  ...
  if (blocks.length === 0) {
    return <div className="pinnacleai-w-full pinnacleai-p-4 pinnacleai-text-pinnacleai-fg-4 pinnacleai-text-sm">No changes found</div>;
  }

  // Display all blocks
  return (
    <div className="pinnacleai-w-full pinnacleai-flex pinnacleai-flex-col pinnacleai-gap-2">
			{blocks.map((block, index) =>
      <div key={index} className="pinnacleai-w-full">
					{blocks.length > 1 &&
        <div className="pinnacleai-text-pinnacleai-fg-4 pinnacleai-text-xs pinnacleai-mb-1 pinnacleai-px-1">
