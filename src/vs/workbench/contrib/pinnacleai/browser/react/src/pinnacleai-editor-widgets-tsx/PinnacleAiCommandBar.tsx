	...
	if (currFileIdx === null) {
		return (
			<div className="pointer-events-auto">
				<div className="flex bg-pinnacleai-bg-2 shadow-md border border-pinnacleai-border-2 [&>*:first-child]:pl-3 [&>*:last-child]:pr-3 [&>*]:border-r [&>*]:border-pinnacleai-border-2 [&>*:last-child]:border-r-0">
		...
		<div className="pointer-events-auto">
			...
			{showAcceptRejectAllButtons && showAcceptRejectAll && (
				<div className="flex justify-end mb-1">
					<div className="inline-flex bg-pinnacleai-bg-2 rounded shadow-md border border-pinnacleai-border-2 overflow-hidden">
						<div className="flex items-center [&>*]:border-r [&>*]:border-pinnacleai-border-2 [&>*:last-child]:border-r-0">
			...
			<div className="flex items-center bg-pinnacleai-bg-2 rounded shadow-md border border-pinnacleai-border-2 [&>*:first-child]:pl-3 [&>*:last-child]:pr-3 [&>*]:px-3 [&>*]:border-r [&>*]:border-pinnacleai-border-2 [&>*:last-child]:border-r-0">
