...
// The extension this was called from is here - https://github.com/pinnacleaieditor/pinnacleai/blob/autocomplete/extensions/pinnacleai/src/extension/extension.ts
...
export class AutocompleteService extends Disposable implements IAutocompleteService {
	...
	static readonly ID = 'pinnacleai.autocompleteService'
