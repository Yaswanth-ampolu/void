...
import { PINNACLEAI_ACCEPT_DIFF_ACTION_ID, PINNACLEAI_REJECT_DIFF_ACTION_ID, PINNACLEAI_GOTO_NEXT_DIFF_ACTION_ID, PINNACLEAI_GOTO_PREV_DIFF_ACTION_ID, PINNACLEAI_GOTO_NEXT_URI_ACTION_ID, PINNACLEAI_GOTO_PREV_URI_ACTION_ID, PINNACLEAI_ACCEPT_FILE_ACTION_ID, PINNACLEAI_REJECT_FILE_ACTION_ID, PINNACLEAI_ACCEPT_ALL_DIFFS_ACTION_ID, PINNACLEAI_REJECT_ALL_DIFFS_ACTION_ID } from './actionIDs.js';
...
export interface IPinnacleAICommandBarService {
...
export const IPinnacleAICommandBarService = createDecorator<IPinnacleAICommandBarService>('PinnacleAICommandBarService');
...
export class PinnacleAICommandBarService extends Disposable implements IPinnacleAICommandBarService {
	...
	static readonly ID: 'pinnacleai.PinnacleAICommandBarService'
	...
	async goToURIIdx(idx: number | null): Promise<void> {
		...
		const { model } = await this._pinnacleaiModelService.getModelSafe(nextURI);
		if (!model) return;
...
export type PinnacleAICommandBarProps = {
	uri: URI | null;
	editor: ICodeEditor;
}
	...
	constructor({ editor }: { editor: ICodeEditor, },
		...
		this.instantiationService.invokeFunction(accessor => {
			...
			this._register(editor.onWillChangeModel((model) => {
				...
				res.rerender({ uri, editor } satisfies PinnacleAICommandBarProps)
			}))
		})
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: PINNACLEAI_ACCEPT_DIFF_ACTION_ID,
			f1: true,
			title: localize2('pinnacleaiAcceptDiffAction', 'PinnacleAI: Accept Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: PINNACLEAI_REJECT_DIFF_ACTION_ID,
			f1: true,
			title: localize2('pinnacleaiRejectDiffAction', 'PinnacleAI: Reject Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: PINNACLEAI_GOTO_NEXT_DIFF_ACTION_ID,
			f1: true,
			title: localize2('pinnacleaiGoToNextDiffAction', 'PinnacleAI: Go to Next Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: PINNACLEAI_GOTO_PREV_DIFF_ACTION_ID,
			f1: true,
			title: localize2('pinnacleaiGoToPrevDiffAction', 'PinnacleAI: Go to Previous Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: PINNACLEAI_GOTO_NEXT_URI_ACTION_ID,
			f1: true,
			title: localize2('pinnacleaiGoToNextUriAction', 'PinnacleAI: Go to Next File with Diffs'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: PINNACLEAI_GOTO_PREV_URI_ACTION_ID,
			f1: true,
			title: localize2('pinnacleaiGoToPrevUriAction', 'PinnacleAI: Go to Previous File with Diffs'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: PINNACLEAI_ACCEPT_FILE_ACTION_ID,
			f1: true,
			title: localize2('pinnacleaiAcceptFileAction', 'PinnacleAI: Accept All Diffs in Current File'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: PINNACLEAI_REJECT_FILE_ACTION_ID,
			f1: true,
			title: localize2('pinnacleaiRejectFileAction', 'PinnacleAI: Reject All Diffs in Current File'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: PINNACLEAI_ACCEPT_ALL_DIFFS_ACTION_ID,
			f1: true,
			title: localize2('pinnacleaiAcceptAllDiffsAction', 'PinnacleAI: Accept All Diffs in All Files'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: PINNACLEAI_REJECT_ALL_DIFFS_ACTION_ID,
			f1: true,
			title: localize2('pinnacleaiRejectAllDiffsAction', 'PinnacleAI: Reject All Diffs in All Files'),
			keybinding: {
