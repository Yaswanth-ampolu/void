...
/* eslint-disable */ // Void
import { PINNACLEAI_CTRL_K_ACTION_ID, PINNACLEAI_CTRL_L_ACTION_ID } from '../../../contrib/pinnacleai/browser/actionIDs.js';
	...
	private render(): void {
		...
		const update = async () => {
			...
			if (this.contextService.getWorkbenchState() === WorkbenchState.EMPTY) {
				...
				const keys = this.keybindingService.lookupKeybinding(PINNACLEAI_CTRL_L_ACTION_ID);
				...
				const keys2 = this.keybindingService.lookupKeybinding(PINNACLEAI_CTRL_K_ACTION_ID);
